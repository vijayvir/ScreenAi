 ...
 * Includes security features: password protection, viewer approval, and
 * banning.
 */
public class ReactiveRoom {
    ...
    public void setPassword(String hash, String salt) {
        ...
        this.requiresApproval = false; // Password validation is sufficient — no host approval needed
    }
     ...
     */
    public void addPendingViewer(String sessionId, String username, WebSocketSession session,
            Sinks.Many<WebSocketMessage> sink) {
        pendingViewers.put(sessionId,
                new PendingViewer(sessionId, username, session, sink, System.currentTimeMillis()));
    }
     ...
     */
    public void addViewer(String sessionId, String username, WebSocketSession session,
            Sinks.Many<WebSocketMessage> sink) {
     ...
     */
    public record ViewerInfo(String sessionId, String username, WebSocketSession session,
            Sinks.Many<WebSocketMessage> sink) {
